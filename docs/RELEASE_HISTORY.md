...
## What makes `0.1.0` meaningful

`0.1.0` is not just a tag placeholder. It already includes:

- a reusable MoonBit package
- CI and release-readiness workflows
- official fixture compatibility evidence
- a browser-facing playground
- downstream and adoption-oriented consumer proofs
- bundle rendering and validation workflows
- public repository governance and contribution surfaces
