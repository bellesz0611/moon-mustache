...
- [Compatibility Lab Evidence](https://bellesz0611.github.io/moon-mustache/#evidence) 提供 Render、Diagnose、Compare、Evidence、Generate 五条评审路径；Evidence 直接读取生成指标并展开逐 mutant JUnit 对应关系。
...
2. Compare 即时展示 Moon Mustache 与 `mustache.js` 输出；Evidence 同屏展示固定官方 corpus、差分、Mutation、后端和 CLI 证据。
