...
- generated at: `2026-07-23T12:43:08+00:00`
- generated at commit: `f1df435`
- working tree: `clean`
- public commit count: `104`
...
- physical MoonBit source lines across library, CLI, demos, reports, benchmarks, consumer proofs, and bridges: `11942`
- effective MoonBit source lines after excluding blank and comment-only lines: `10889`
- handwritten effective MoonBit lines: `8740`
...
- repository-wide instrumented lines: `2056 / 3220` (`63.9%`, informational; CLI, bridges, and demos are verified by integration/smoke jobs rather than this unit-coverage gate)
- CLI black-box integration: `15 / 15` passing
...
- latest GitHub library workflow conclusion: `success` for commit `4192a1c`
- latest GitHub library workflow URL: <https://github.com/bellesz0611/moon-mustache/actions/runs/30006865759>
