...
- generated at commit: `9395546`
- public commit count: `48`
...
- total MoonBit LOC across library, CLI, demos, reports, benchmarks, consumer demos, bridge code, and companion blueprint proof: `9026`
- handwritten MoonBit LOC in those surfaces: `7512`
...
- latest GitHub library workflow conclusion: `success` for commit `7f1bf80`
- latest GitHub library workflow URL: <https://github.com/bellesz0611/moon-mustache/actions/runs/29027922412>

## Publication snapshot

- mooncakes latest version: `0.1.0`
- mooncakes build status: `success`
- mooncakes download count reported by API: `2`
