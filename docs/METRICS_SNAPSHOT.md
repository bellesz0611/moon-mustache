...
- generated at: `2026-07-21T11:34:54+00:00`
- generated at commit: `f9bee9c`
- working tree: `clean`
- public commit count: `64`
...
- physical MoonBit source lines across library, CLI, demos, reports, benchmarks, consumer proofs, and bridges: `11482`
- effective MoonBit source lines after excluding blank and comment-only lines: `10481`
- handwritten effective MoonBit lines: `8332`
...
- repository-wide instrumented lines: `1890 / 3134` (`60.3%`, informational; CLI, bridges, and demos are verified by integration/smoke jobs rather than this unit-coverage gate)
...
- latest GitHub library workflow conclusion: `success` for commit `920f99f`
- latest GitHub library workflow URL: <https://github.com/bellesz0611/moon-mustache/actions/runs/29824691627>
