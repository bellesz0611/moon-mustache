...
- current code scale: about `7441` MoonBit LOC across library, CLI, demos, reports, benchmarks, consumer scenarios, and bridge code
- handwritten MoonBit LOC: about `5928`
...
- public git history: `36+` commits and still growing
