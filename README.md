...
- current code scale: about `7352` MoonBit LOC across library, CLI, demos, reports, benchmarks, and bridge code
- handwritten MoonBit LOC: about `5839`
...
- public git history: `35+` commits and still growing
- key demos: CLI rendering, template scanning, bundle generation, scenario report, three consumer-style demos, and a Vue playground backed by the repository's own MoonBit engine
...
- 手写 MoonBit 代码约 `5839` 行
- 导入上游 fixture 后生成的 MoonBit 测试资产约 `1513` 行
- 合计约 `7352` 行 MoonBit 代码
