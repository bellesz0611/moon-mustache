...
- current code scale: about `8791` MoonBit LOC across library, CLI, demos, reports, benchmarks, consumer scenarios, bridge code, and companion blueprint proof
- handwritten MoonBit LOC: about `7277`
...
- 手写 MoonBit 代码约 `7277` 行
- 导入上游 fixture 后生成的 MoonBit 测试资产约 `1514` 行
- 合计约 `8791` 行 MoonBit 代码
