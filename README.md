...
- current code scale: about `8676` MoonBit LOC across library, CLI, demos, reports, benchmarks, consumer scenarios, bridge code, and companion blueprint proof
- handwritten MoonBit LOC: about `7162`
...
- 手写 MoonBit 代码约 `7162` 行
- 导入上游 fixture 后生成的 MoonBit 测试资产约 `1514` 行
- 合计约 `8676` 行 MoonBit 代码
