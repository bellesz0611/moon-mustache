...
- public git history: `29+` commits and still growing
- key demos: CLI rendering, template scanning, bundle generation, scenario report, downstream consumer, and a Vue playground backed by the repository's own MoonBit engine
