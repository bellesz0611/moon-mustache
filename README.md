...
- current code scale: about `8081` MoonBit LOC across library, CLI, demos, reports, benchmarks, consumer scenarios, bridge code, and companion blueprint proof
- handwritten MoonBit LOC: about `6568`
...
- public git history: `40+` commits and still growing
...
- bundle 输出路径模板渲染与安全校验
- manifest profile 解析与批量模板工程生成
- prepared manifest profile 预编译入口
